/* =====================================================================
   ...
   Rango (SoloQ + Flex), nivel, maestrías y estado EN PARTIDA.
   ===================================================================== */
...
module.exports = async function (context, req) {
  const send = (status, body) => { context.res = { status, headers:{ "Content-Type":"application/json", "Cache-Control":"public, max-age=120" }, body }; };
  ...
  try{
    ...
    const data = {
      riotId, puuid,
      gameName: account.gameName || gameName, tagLine: account.tagLine || tagLine,
