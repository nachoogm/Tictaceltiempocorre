...
module.exports=async function(context,req){
  ...
  try{
    ...
    const data={riotId,puuid,gameName:account.gameName||gameName,tagLine:account.tagLine||tagLine,level:summoner.summonerLevel||null,profileIconId:summoner.profileIconId??null,solo:pick("RANKED_SOLO_5x5"),flex:pick("RANKED_FLEX_SR"),topChamps:(masteries||[]).map(m=>({championId:m.championId,points:m.championPoints,level:m.championLevel})),live:live.inGame?{gameMode:live.gameMode,minutes:Math.floor((live.gameLength||0)/60)}:null};
