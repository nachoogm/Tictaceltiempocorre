/* /api/cron-lp — snapshot diario de LP + PURGA a 90 días. Lo dispara un GitHub Action a las 23:00.
...
const PLAYERS=["Cebolokoh98#SOC","BARI POPPYNS#2025","MLVVND El Piruko#EUW","ette secht#EUW","Hi Im Gonza#7385","Parisuko#EUW","tacua#EUW","Tacuoptero#3612","sukooo#suko"];
...
module.exports = async function (context, req) {
  ...
  // 2) PURGA de registros con más de RETENTION_DAYS (90 días)
  let purged=0;
  try{
