/* /api/live — partida EN VIVO (spectator-v5). Caché PUUID + 30s + reintento 429 */
...
module.exports=async function(context,req){
  ...
  try{
    ...
    const parts=(g.participants||[]).map(p=>({riotId:p.riotId||p.summonerName||"—",championId:p.championId,teamId:p.teamId,spell1:p.spell1Id,spell2:p.spell2Id,keystone:(p.perks&&p.perks.perkIds&&p.perks.perkIds[0])||0,primaryStyle:(p.perks&&p.perks.perkStyle)||0,subStyle:(p.perks&&p.perks.perkSubStyle)||0,isMe:p.puuid===puuid}));
