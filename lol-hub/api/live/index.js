...
module.exports=async function(context,req){
  ...
  try{
    ...
    const parts=(g.participants||[]).map(p=>({riotId:p.riotId||p.summonerName||"—",championId:p.championId,teamId:p.teamId,spell1:p.spell1Id,spell2:p.spell2Id,keystone:(p.perks&&p.perks.perkIds&&p.perks.perkIds[0])||0,isMe:p.puuid===puuid}));
