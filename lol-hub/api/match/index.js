...
module.exports=async function(context,req){
  ...
  try{
    ...
    const parts=(info.participants||[]).map(p=>{
      ...
      cs,csPerMin:+((cs/durMin)||0).toFixed(1),gold:p.goldEarned||0,damage:p.totalDamageDealtToChampions||0,damagePct:Math.round(((p.totalDamageDealtToChampions||0)/maxDmg)*100),
      ...
      items:[p.item0,p.item1,p.item2,p.item3,p.item4,p.item5,p.item6],spell1:p.summoner1Id,spell2:p.summoner2Id,win:p.win};});
