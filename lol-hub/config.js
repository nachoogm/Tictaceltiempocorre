...
const CONFIG = {
  ...
  /* 🎵 PLAYLIST
     · Sube los .mp3 a la carpeta  music/
     · Sube la portada a           music/cover.jpg
     'cover' por defecto para todas las canciones; puedes poner uno distinto
     por canción añadiendo  cover:"music/otra.jpg"  en su línea. */
  ...
  songs: [
    ...
    { title:"Ranchera",             artist:"San Quintín", file:"San Quintín ranchera.mp3" },
    { title:"Rock",                 artist:"San Quintín", file:"San Quintín rock.mp3" },
    { title:"Tacuantino pro",       artist:"Tacuóptero",  file:"Tacuóptero Tacuantino pro.mp3" }
  ]
};
