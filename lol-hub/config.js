/* =====================================================================
   ...
   main:   campeón para la FOTO de perfil (tal cual DataDragon: Galio,
           Akshan, Vayne, Lulu, LeeSin, MissFortune, MonkeyKing=Wukong...)
   liveStats: true = rango/winrate/maestrías/en-partida/historial
   ===================================================================== */
